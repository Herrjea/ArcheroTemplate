...
public class SaveDataEditor : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        if (loaded)
        {
            ...
            GUILayout.Label("SoftCoins", GUILayout.Height(height), GUILayout.Width(200));
            saveData.softCoins = EditorGUILayout.IntField(saveData.softCoins, GUILayout.Height(height), GUILayout.Width(50));
